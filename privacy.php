...
<title>TML | Privacy Page</title>
</head>

<body>
    <div class="container">
        <!-- <h1>Restaurant Management Essentials</h1> -->

        <?php include('includes/nav_bar.php') ?>
        <?php include('includes/loginbar.php') ?>


        <!-- <p>where Restaurntuers come for insight.</p> -->
        <div class="content">

            <h1>Privcy Page</h1>

            <p>
                restaurantmanagementessentials operates the
                restaurantmanagementessentials.com website, which provides the
                SERVICE.
            </p>
            ...
            <p>
                ...
                anyone decided to use our Service, the restaurantmanagementessentials
                website.
            </p>
            ...
            <p>
                ...
                restaurantmanagementessentials.com, unless otherwise defined in this
                Privacy Policy.
            </p>
        ...
        </div><!-- more content still to come here ... -->
